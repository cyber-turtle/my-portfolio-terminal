// Adapted Barrel class for React - accepts sprites instance as parameter
...
export class Barrel {
    ...
    update(ctx, sprites, platforms, player, elapsed) {

        this.move();
        this.step(ctx, sprites, elapsed);
        this.gravity();
